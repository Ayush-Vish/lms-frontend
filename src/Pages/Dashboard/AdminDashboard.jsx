...
import { deleteCourse, getAllCourses } from "../../Redux/Slices/course.slice";
import { getPaymentRecord } from "../../Redux/Slices/razorpay.slice";
import { getStasData } from "../../Redux/Slices/Stats.slice";
...
function AdminDashboard() {
    ...
    const { allUserCount, subscriberCount } = useSelector((state) => state.stats);
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            ...
                            <div className="flex items-center justify-between p-5 gap-5 rounded-md shadow-md">
                                <div className="flex flex-col items-center">
                                    ...
                                    <h3 className="text-4xl font-bold">{subscriberCount * 499}</h3>
                                </div>
